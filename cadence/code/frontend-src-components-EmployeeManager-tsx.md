...
type: file
tags: [code/frontend]
aliases: ["frontend/src/components/EmployeeManager.tsx"]
created: 2026-07-15
updated: 2026-07-15
related: ["[[US-31]]"]
sources: []
...
Employee management section of the Owner Console. Provides interface for managing staff accounts and permissions.
...
## Exports
- `EmployeeManager` (component) -- employee account and permission editor
